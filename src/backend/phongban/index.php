...
// Yêu cầu `Twig` vẽ giao diện được viết trong file `backend/phongban/index.html.twig`
// với dữ liệu truyền vào file giao diện được đặt tên là `dataPhongban`
echo $twig->render('backend/phongban/index.html.twig', [
    'dataPhongban' => $data,
    'paginator' => $paginator
]);
